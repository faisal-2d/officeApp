...
const RefundPolicy = () => {
  return (
    <div className='mt-28 flex flex-col md:flex-row justify-center items-center'>
        ...
        <p><span className='font-bold text-green-600'><FontAwesomeIcon icon={faCheckCircle}></FontAwesomeIcon> অবহেলা করলে রিফান্ড পাবেন না।</span>ভর্তির হওয়ার পর পড়াশোনা না করলে, পরীক্ষা না দিলে, কোর্সের সাথে না থাকলে আপনাকে কোর্স ফী ফেরত দেওয়া হবে না।</p>
        <p><span className='font-bold text-green-600'><FontAwesomeIcon icon={faCheckCircle}></FontAwesomeIcon> রিফান্ড পেতে কতো সময় লাগতে পারেঃ</span> আমাদের সাথে যোগাযোগ করলে অতিদ্রুত আমরা ব্যবস্থা নিব। সাধারণত ১ দিনের মধ্যেই রিফান্ড পেয়ে যাবেন।</p>
        <p className='mt-5'>কোর্সে ভর্তির পরে যদি নিয়মিত পড়াশোনা না করেন, পরীক্ষা না দেন, এবং উল্লেখিত নিয়ম অনুযায়ী আমাদেরকে না জানান, কোর্সে অনুপস্থিত বা ইনঅ্যাক্টিভ থাকেন, পরবর্তী ব্যাচে ভর্তি হতে চাইলে আপনাকে আবার পুরো ফী (১৫০০ টাকা) পরিশোধ করে ভর্তি হতে হবে।</p>
