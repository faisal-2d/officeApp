...
const CardArabicNextBatch = () => {
  ...
  const m = digitConverter(remainingMonths);
    ...
    return (
        <div className='bg-lime-100 p-5 md:p-16 rounded text-white my-10'>
                <div className='mb-10'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3 text-black text-xl'>
                    ...
                    <p className='p-3 bg-orange-300 rounded'>ভর্তি শেষ হবে ১২ আগস্ট </p>
                    <p className='p-3 bg-red-300 rounded'>ক্লাস শুরু হবে ১৫ আগস্ট</p>
                    {/* <p className='p-3 bg-blue-300 rounded'>অরিয়েন্টেশন ক্লাস ১৫ আগস্ট</p> */}
