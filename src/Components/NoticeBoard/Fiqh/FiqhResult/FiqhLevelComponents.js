    ...
    return (
      <section className="my-10">
           ...
           ></GroupLinks> */}
            ...
            <p className='text-xl'>Course: Fiqh Level {level} </p>
            
            <br />
                <div className="text-center mb-8">
                    <Link className="py-3 px-5 rounded bg-green-300" to={'/leaderboard'+level+'-fiqh-'+batch+'/'+sn}> <FontAwesomeIcon icon="fa-solid fa-trophy" /> Leaderboard</Link>
                </div>
            </div>
