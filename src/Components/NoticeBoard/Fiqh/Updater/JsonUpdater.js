...
const JsonUpdater = () => {
        ...
        // jsonData.map(data => {
                ...
                if(dateType ==="certificate"){
                    ...
                    jsonData.map(data => {
                        ...
                        axios.put(`https://alharamanin-backend-web.onrender.com/fiqh${batchNo}/${level}/certificate/${data.sn}`, data)
                    ...
                    jsonData.map(data => {
                        ...
                        axios.put(`https://alharamanin-backend-web.onrender.com/fiqh${batchNo}/${level}/leaderboard/${data.sn}`, leadData)
                        .then(data => console.log(data.data))                      
   ...
   return (
        <div>
                ...
                <p className='text-2xl text-center mb-5'>Fiqh Course</p>
