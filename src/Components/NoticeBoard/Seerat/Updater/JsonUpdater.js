...
const JsonUpdater = () => {
        ...
        // jsonData.map(data => {
                ...
                if(dateType ==="certificate"){
                    ...
                    jsonData.map(data => {
                        ...
                        axios.put(`https://alharamanin-backend-web.onrender.com/seerat${batchNo}/${level}/certificate/${data.sn}`, data)
                    ...
                    axios.put(`https://alharamanin-backend-web.onrender.com/seerat${batchNo}/${level}/exm${exmNo}/${data.sn}`, resultData)
                    .then(data => console.log(data.data))
                    
                })
                    // console.log(`resultdate: https://alharamanin-backend-web.onrender.com/seerat${batchNo}/${level}/exm${exmNo}/${data.sn}`);
                }
                    ...
                    jsonData.map(data => {
                        ...
                        axios.put(`https://alharamanin-backend-web.onrender.com/seerat${batchNo}/${level}/leaderboard/${data.sn}`, leadData)
                        .then(data => console.log(data.data))                      
                        
                    })
                    // console.log(`leadData: https://alharamanin-backend-web.onrender.com/seerat${batchNo}/${level}/leaderboard/${data.sn}`);
                }
                    ...
                    if(level === 'level1'){
                        jsonData.map(data => {
                            ...
                            const insertData = {
                                ...
                                "phone" : data.phone,
                                "gender" : data.gender,
                                "seerat1payment" : data.seerat1payment,
                                "seerat1data" : [{
                                    "name" : "Exm 1",
                                    "Score" : 0
                                }
                                ...
                                axios.post(`https://alharamanin-backend-web.onrender.com/register/seerat/${batchNo}`, insertData)
                                .then(data => {
                        ...
                        jsonData.map(data => {
                            ...
                            const insertData = {
                                ...
                                "phone" : data.phone,
                                "gender" : data.gender,
                                "seerat2payment" : data.seerat2payment,
                                "seerat2data" : [{
                                    "name" : "Exm 1",
                                    "Score" : 0
                                }
   ...
   return (
        <div>
                ...
                <p className='text-2xl text-center mb-5'>Seerat Course</p>
