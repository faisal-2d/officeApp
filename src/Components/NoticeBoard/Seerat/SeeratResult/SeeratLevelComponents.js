...
import SeeratBarchart from './SeeratBarchart';
import { Link } from 'react-router-dom';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';

const SeeratLevelComponents = ({batch, data, level, gender, sn}) => {
    ...
    return (
      <section className="my-10">
           ...
           ></GroupLinks> */}
            ...
            <p className='text-xl'>Course: Seerat Level {level} </p>
            
            <br />
                <div className="text-center mb-8">
                    <Link className="py-3 px-5 rounded bg-green-300" to={'/leaderboard'+level+'-seerat-'+batch+'/'+sn}> <FontAwesomeIcon icon="fa-solid fa-trophy" /> Leaderboard</Link>
                </div>
            </div>
...
export default SeeratLevelComponents;