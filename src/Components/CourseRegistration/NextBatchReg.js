...
const NextBatchReg = () => {
    ...
    const addmissionStartDate = new Date("30 Mar 2024");    //months start from 0
    ...
    return (
        <div className='bg-sky-100 p-5 md:p-16 rounded text-white my-10'>
                ...
                { today<addmissionStartDate
                  ...
                  :  <p className='text-center text-sky-900  text-3xl mb-4'>আক্বিদাহ কোর্সের ২২ তম ব্যাচে ভর্তি চলছে!</p>
                } 
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3 text-black text-xl'>
                    ...
                    <p className='p-3 bg-orange-300 rounded'>ভর্তি শেষ হবে ৭ মে </p>
                    <p className='p-3 bg-blue-300 rounded'>অরিয়েন্টেশন ক্লাস ৯ মে</p>
                    {/* <p className='p-3 bg-yellow-300 rounded'>ক্লাস শুরু হবে ১২ মে</p> */}
