      ...
      <section className="px-5">
        <div className="my-20 grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="order-2">
            ...
            <ul className="ml-16" style={{ listStyleType: "disc" }}>
              ...
              <li>
                সকল নবী-রাসূলগনের আক্বিদাহ একই ছিল, এবং তারা প্রত্যেকে তাদের
                উম্মতকে তাওহীদের দাওয়াত দিয়ে গেছেন।{" "}
              </li>
              <li>
                সাহাবী (রা), তাবেয়ী (রা) এবং চারজন ইমাম (ইমাম আবু হানিফা (র.),
                ইমাম মালেক (র.), ইমাম শাফেয়ী (র.) এবং ইমাম আহমাদ বিন হাম্বাল
                (র.)) - এর আক্বিদাহ একই। এবাং তা হলো বিশুদ্ধ আক্বিদাহ।{" "}
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="my-20 grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            ...
            <p className="mt-5">
              এই কোর্সে আমরা আমাদের সৃষ্টিকর্তা আল্লাহ সম্পর্কে জানতে পারবো -
            </p>
            <ul className="ml-16" style={{ listStyleType: "disc" }}>
              <li>তিনি কে?</li>
            ...
            <ul className="ml-16" style={{ listStyleType: "disc" }}>
              ...
              <li>
                কোন ভুলের কারনে একজন মানুষের সারা জীবনের আমল (সলাত, সিয়াম, হজ্ব,
                যাকাত, দান- সদকা ইত্যাদি) নষ্ট হয়ে যাবে?
              </li>
            </ul>
          </div>
          <div>
